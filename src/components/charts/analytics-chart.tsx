...
export function AnalyticsChart() {
  ...
  return (
    <section className="glass min-w-0 rounded-2xl p-4 sm:rounded-3xl sm:p-6">
      ...
      <ClientChart className="mt-4 h-52 min-h-[208px] w-full min-w-0 sm:mt-6 sm:h-72 sm:min-h-[288px]">
